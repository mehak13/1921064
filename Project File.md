...
k = c-g;
l = d-h;
printf("\n\nSubstraction of Matrix(A-B) is: | %.2f%.2f |",i,j,k,l);
i = e-a;
j = f-b;
k = g-c;
l = h-d;
printf("\n\nSubstraction of Matrix(B-A) is: | %.2f%.2f |",i,j,k,l);
return 0;}
## Output of the program
...
k=(c*e)+(d*g);
l=(c*f)+(d*h);
printf("\nMultiplication of A,B is: | %.2freturn 0;}
## Output of the program
Sample of Ist matrix: | a=1| c=3d=4 |
Sample of 2nd matrix: | e=5| f=7h=8 |
Enter The Valve of a: 7
...
Enter The Valve of g: 9
Enter The Valve of h: 1
Multiplication of A,B is: | 66.00 40.00 || 12.00 20.00 |
